...
export default function Dashboard({ goTo }) {
  ...
  // Clean Circular Progress calculation
  const radius = 40
  const strokeWidth = 7
  ...
  return (
    <div className="mx-auto w-full max-w-7xl px-4 py-4 sm:px-6 text-[#0C1E30]">
      {/* ============================================================
          TOP HEADER: STATION & STATUS (Compact, Single-Line, Clean)
          ============================================================ */}
      <header className="mb-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1 border-b border-[#DCE8F0] pb-2.5">
        <div className="flex items-center gap-3">
          <h1 className="text-xl sm:text-2xl font-semibold tracking-tight text-[#0C1E30]">
            Maitri Station
          </h1>
          <div className="flex items-center gap-1.5 text-xs font-medium text-emerald-700 bg-emerald-50 border border-emerald-200 px-2 py-0.5 rounded-full">
            <span className="h-1.5 w-1.5 rounded-full bg-emerald-500 animate-pulse" />
            <span>Operational</span>
          </div>
        </div>

        <div className="text-[11.5px] text-[#64748B] font-mono flex items-center gap-2">
          <span>70°45′S, 11°44′E</span>
          <span className="text-[#DCE8F0]">·</span>
          <span>Austral Summer Campaign ISEA-44</span>
        </div>
      </header>

      {/* ============================================================
          PRIMARY 3-COLUMN × 2-ROW COCKPIT GRID
          Desktop: 3 columns × 2 rows (fits in 1 viewport)
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {/* ============================================================
            ...
            ============================================================ */}
        <div className="rounded-xl border border-[#DCE8F0] bg-white p-4 sm:p-5 shadow-xs flex flex-col justify-between h-[215px]">
          <div className="flex items-center justify-between border-b border-[#F1F5F9] pb-2">
            ...
            <button
              ...
              className="text-[#0284C7] hover:underline text-[11px] font-medium"
            >
              Details →
            </button>
          </div>
          ...
          <div className="flex items-center justify-center gap-5 my-auto">
            ...
            <div className="space-y-0.5">
              <div className="inline-flex items-center gap-1.5 rounded-md bg-emerald-50 px-2 py-0.5 text-[11px] font-semibold text-emerald-700 border border-emerald-200">
                <span className="h-1.5 w-1.5 rounded-full bg-emerald-500" />
                Stable
              </div>
              <div className="text-[11px] text-[#64748B] font-mono pt-1 flex items-center gap-1">
          ...
          <div className="pt-2 border-t border-[#F1F5F9] text-[11px] text-[#64748B] truncate">
        ...
        <div className="rounded-xl border border-[#DCE8F0] bg-white p-4 sm:p-5 shadow-xs flex flex-col justify-between h-[215px]">
          <div className="flex items-center justify-between border-b border-[#F1F5F9] pb-2">
            <h2 className="text-[11px] font-mono uppercase tracking-wider font-bold text-[#0C1E30]">
              Needs Attention
            </h2>
            <span className="text-[10.5px] font-mono text-rose-600 bg-rose-50 px-1.5 py-0.5 rounded border border-rose-200">
              3 Active
            </span>
          </div>
          ...
          <div className="space-y-2 my-auto">
            ...
            <button
              ...
              className="w-full flex items-center justify-between px-2.5 py-1.5 rounded-lg border border-rose-200/80 bg-rose-50/40 hover:bg-rose-50 transition text-left group"
            >
              <div className="flex items-center gap-2 min-w-0">
                <span className="h-2 w-2 rounded-full bg-rose-600 shrink-0" />
                <span className="text-xs font-semibold text-[#0C1E30] truncate group-hover:text-rose-700">
                  Fuel resupply
                </span>
              </div>
              <span className="font-mono text-[11px] font-bold text-rose-700 shrink-0 flex items-center gap-0.5">
                5-day gap <ChevronRight size={12} />
              </span>
            </button>
            ...
            <button
              ...
              className="w-full flex items-center justify-between px-2.5 py-1.5 rounded-lg border border-amber-200/80 bg-amber-50/40 hover:bg-amber-50 transition text-left group"
            >
              <div className="flex items-center gap-2 min-w-0">
                <span className="h-2 w-2 rounded-full bg-amber-500 shrink-0" />
                <span className="text-xs font-semibold text-[#0C1E30] truncate group-hover:text-amber-700">
                  Generator
                </span>
              </div>
              <span className="font-mono text-[11px] font-bold text-amber-700 shrink-0 flex items-center gap-0.5">
                Review (60h) <ChevronRight size={12} />
              </span>
            </button>
            ...
            <button
              ...
              className="w-full flex items-center justify-between px-2.5 py-1.5 rounded-lg border border-emerald-200/80 bg-emerald-50/40 hover:bg-emerald-50 transition text-left group"
            >
              <div className="flex items-center gap-2 min-w-0">
                <span className="h-2 w-2 rounded-full bg-emerald-500 shrink-0" />
                <span className="text-xs font-semibold text-[#0C1E30] truncate group-hover:text-emerald-700">
                  Cargo C-104
                </span>
              </div>
              <span className="font-mono text-[11px] font-bold text-emerald-700 shrink-0 flex items-center gap-0.5">
                Day 17 <ChevronRight size={12} />
              </span>
            </button>
          </div>
        ...
        <div className="rounded-xl border border-[#DCE8F0] bg-white p-4 sm:p-5 shadow-xs flex flex-col justify-between h-[215px]">
          ...
          <div className="divide-y divide-[#F1F5F9] text-xs my-auto">
            <div className="py-2 flex items-center justify-between">
              <span className="text-[#42586E]">Fuel consumption</span>
            ...
            <div className="py-2 flex items-center justify-between">
              <span className="text-[#42586E]">Cargo ETA</span>
            ...
            <div className="py-2 flex items-center justify-between">
              <span className="text-[#42586E]">Generator Output</span>
          ...
          <div className="pt-2 border-t border-[#F1F5F9] flex items-center justify-between text-[11px]">
            ...
            <button
              ...
              className="text-[#0284C7] hover:underline font-medium flex items-center gap-0.5"
            >
        ...
        <div className="rounded-xl border border-[#DCE8F0] bg-white p-4 sm:p-5 shadow-xs flex flex-col justify-between h-[215px]">
          ...
          {/* Clean Compact SVG Sparkline */}
          <div className="my-auto py-1">
            <svg viewBox="0 0 280 50" className="w-full h-12 overflow-visible">
              <defs>
              ...
              <polygon
                points="15,10 75,18 140,26 205,34 265,42 265,50 15,50"
              ...
              <polyline
                ...
                points="15,10 75,18 140,26 205,34 265,42"
              />
              <circle cx="15" cy="10" r="3" fill="#0284C7" />
              <circle cx="75" cy="18" r="3" fill="#0284C7" />
              <circle cx="140" cy="26" r="3" fill="#0284C7" />
              <circle cx="205" cy="34" r="3" fill="#0284C7" />
              <circle cx="265" cy="42" r="3.5" fill="#0284C7" stroke="#FFFFFF" strokeWidth="1.5" />
            </svg>

            <div className="flex items-center justify-between text-[10px] font-mono text-[#64748B] pt-1 px-1">
              {trendPoints.map((pt) => (
        ...
        <div className="rounded-xl border border-[#DCE8F0] bg-white p-4 sm:p-5 shadow-xs flex flex-col justify-between h-[215px]">
          <div className="flex items-center justify-between border-b border-[#F1F5F9] pb-2">
            <div className="flex items-center gap-1.5 text-[11px] font-mono uppercase tracking-wider font-bold text-[#0284C7]">
              <Sparkles size={13} />
          ...
          <div className="my-auto space-y-1">
            <div className="text-sm font-semibold text-[#0C1E30]">
              Fuel risk increasing.
            </div>
            <div className="font-mono text-xs text-[#42586E] space-y-0.5">
          ...
          <div className="pt-2 border-t border-[#F1F5F9] flex items-center justify-between">
            <span className="text-[11px] text-[#64748B]">Deep reasoning ready</span>
            <button
              type="button"
              onClick={() => setActiveDetail('ai')}
              className="rounded-lg bg-[#0284C7] hover:bg-[#0369A1] text-white px-3 py-1.5 text-[11.5px] font-semibold shadow-xs transition active:scale-95 flex items-center gap-1"
            >
              <span>Review</span>
              <ArrowRight size={12} />
            </button>
